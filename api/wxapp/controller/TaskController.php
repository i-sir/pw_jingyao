...
class TaskController
{
     ...
     * 执行定时任务
     *
     *   test_environment: http://pw-jingyao.ikun:9090/api/wxapp/task/index
     *   official_environment: http://jingyao.aejust.net/api/wxapp/task/index
    ...
    /**
     * 每周扣除保证金
     * http://jingyao.aejust.net/api/wxapp/task/dec_bond
     */
    ...
    //通知陪玩 & 余额支付
    //http://jingyao.aejust.net/api/wxapp/task/send

...
class NotifyController extends AuthController
{
     ...
     * 微信支付回调 测试
     *
     *   test_environment: http://pw-jingyao.ikun:9090/api/wxapp/notify/wx_pay_notify_test?pay_num=1000
     *   official_environment: http://jingyao.aejust.net/api/wxapp/notify/wx_pay_notify_test?pay_num=1000

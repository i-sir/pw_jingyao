...
class WxBaseController extends AuthController
{
     ...
     *   official_environment: http://jingyao.aejust.net/api/wxapp/wx_base/wx_refund_test?order_num=250610206819667730
...
//        $amount        = '0.09';//总金额
     ...
     *   official_environment: http://jingyao.aejust.net/api/wxapp/wx_base/send_temp_msg_test
     ...
     *   official_environment: http://jingyao.aejust.net/api/wxapp/wx_base/send_shipping
    ...
    /**
     * 微信转账回调 (官方回调)
     * 调用示例 http://jingyao.aejust.net/api/wxapp/wx_base/notify
     */
    ...
    /**
     *  微信转账实例
     *  调用示例 http://jingyao.aejust.net/api/wxapp/wx_base/example
     */
     ...
     * 调用示例 http://jingyao.aejust.net/api/wxapp/wx_base/update_official_openid
     */
     ...
     *   official_environment: http://jingyao.aejust.net/api/wxapp/wx_base/find_official
     ...
     *   official_environment: http://jingyao.aejust.net/api/wxapp/wx_base/sendTempMsg
     ...
     *   official_environment: http://jingyao.aejust.net/api/wxapp/wx_base/qrcode_create
     ...
     *   official_environment: http://jingyao.aejust.net/api/wxapp/wx_base/addWeixinMenu
     ...
     *   official_environment: http://jingyao.aejust.net/api/wxapp/wx_base/batch_get_material
     ...
     *   official_environment: http://jingyao.aejust.net/api/wxapp/wx_base/get_stable_access_token

 ...
 *     "test_environment"        =>"http://jingyao.aejust.net/api/wxapp/play_reward/index",
 *     "official_environment"    =>"http://jingyao.aejust.net/api/wxapp/play_reward/index",
 * )
 */
...
class PlayRewardController extends AuthController
{
     ...
     * http://jingyao.aejust.net/api/wxapp/play_reward/index
     */
     ...
     *
     *
     *   test_environment: http://jingyao.aejust.net/api/wxapp/play_reward/find_play_reward_list
     *   official_environment: http://jingyao.aejust.net/api/wxapp/play_reward/find_play_reward_list
     ...
     *
     *
     *   test_environment: http://jingyao.aejust.net/api/wxapp/play_reward/add_order
     *   official_environment: http://jingyao.aejust.net/api/wxapp/play_reward/add_order
     ...
     *
     *
     *   test_environment: http://jingyao.aejust.net/api/wxapp/play_reward/find_order_list
     *   official_environment: http://jingyao.aejust.net/api/wxapp/play_reward/find_order_list?openid=olS7D6q9Yz-5xzFJxUpQfuVdgTBQ
     ...
     *
     *
     *   test_environment: http://jingyao.aejust.net/api/wxapp/play_reward/total_amount
     *   official_environment: http://jingyao.aejust.net/api/wxapp/play_reward/total_amount?openid=olS7D6q9Yz-5xzFJxUpQfuVdgTBQ

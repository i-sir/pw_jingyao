...
class SendTempMsgController extends AuthController
{
     ...
     *
     *
     *   test_environment: http://pw-jingyao.ikun:9090/api/wxapp/send_temp_msg/find_official
     *   official_environment: http://jingyao.aejust.net/api/wxapp/send_temp_msg/find_official
     ...
     *
     *   test_environment: http://pw-jingyao.ikun:9090/api/wxapp/send_temp_msg/qrcode_create
     *   official_environment: http://jingyao.aejust.net/api/wxapp/send_temp_msg/qrcode_create
     ...
     * @return  string
     *
     *   test_environment: http://pw-jingyao.ikun:9090/api/wxapp/send_temp_msg/sendTempMsg
     *   official_environment: http://jingyao.aejust.net/api/wxapp/send_temp_msg/sendTempMsg
     ...
     *
     *
     *   test_environment: http://pw-jingyao.ikun:9090/api/wxapp/send_temp_msg/send_temp_msg_test
     *   official_environment: http://jingyao.aejust.net/api/wxapp/send_temp_msg/send_temp_msg_test
     ...
     *
     *   test_environment: http://pw-jingyao.ikun:9090/api/wxapp/send_temp_msg/batch_get_material
     *   official_environment: http://jingyao.aejust.net/api/wxapp/send_temp_msg/batch_get_material
     ...
     *
     *   test_environment: http://pw-jingyao.ikun:9090/api/wxapp/send_temp_msg/get_stable_access_token
     *   official_environment: http://jingyao.aejust.net/api/wxapp/send_temp_msg/get_stable_access_token

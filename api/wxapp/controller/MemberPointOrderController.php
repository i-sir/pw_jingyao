 ...
 *     "test_environment"        =>"http://jingyao.aejust.net/api/wxapp/member_point_order/index",
 *     "official_environment"    =>"http://jingyao.aejust.net/api/wxapp/member_point_order/index",
 * )
 */
...
class MemberPointOrderController extends AuthController
{
     ...
     * http://jingyao.aejust.net/api/wxapp/member_point_order/index
     */
     ...
     * )
     *
     *   test_environment: http://jingyao.aejust.net/api/wxapp/member_point_order/add_order
     *   official_environment: http://jingyao.aejust.net/api/wxapp/member_point_order/add_order

...
class WeChatController extends AuthController
{
     ...
     * 发货测试用
     *
     *   test_environment: http://pw-jingyao.ikun:9090/api/wxapp/we_chat/send_shipping
     *   official_environment: http://jingyao.aejust.net/api/wxapp/we_chat/send_shipping
     ...
     * 订阅消息发送 测试用
     *
     *   test_environment: http://pw-jingyao.ikun:9090/api/wxapp/we_chat/send_test
     *   official_environment: http://jingyao.aejust.net/api/wxapp/we_chat/send_test
     ...
     *
     *   test_environment: http://pw-jingyao.ikun:9090/api/wxapp/we_chat/get_stable_access_token
     *   official_environment: http://jingyao.aejust.net/api/wxapp/we_chat/get_stable_access_token
